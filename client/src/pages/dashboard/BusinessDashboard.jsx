      ...
      return(
        <div>
          ...
          <section class="services-container dark" id="stats">
            <h1 class="page-title page-title-left">BUSINESS STATISTICS</h1>
            ...
            <div class="stats-widgets">
              ...
              <div class="stats-widget white slide-element-right">
                <i class="fa-regular fa-calendar-days fa-5x stats-widget-icon"></i>
                <h4 class="stats-widget-title">Appointments within last month</h4>
                <p class="stats-widget-value">150</p>
              </div>
